...
namespace iPlant.Common.Tools
{
    public class StringUtils
    {
        ...
        public static int parseInt(Object value, int wDefaultValue = 0)
        {
            int wResult = wDefaultValue;
            if (value != null)
            {
                try
                {
        ...
        public static Double parseDouble(Object value, int wDefaultValue = 0)
        {
            Double wResult = wDefaultValue;
            if (value != null)
            {
                try
                {
        ...
        public static DateTime parseDate(object value)
        {
            ...
            try
            {
                ...
                if ((value is String) && value.ToString().Length >= 4)
                {
                    ...
                    if (wMatcher.Success)
                    {
                        wResult = parseDate(value + ":00", StringUtils.Format("yyyy{0}MM{1}dd{2}HH@mm:ss", wMatcher.Groups[1],
                                wMatcher.Groups[2], wMatcher.Groups[3]));
                        return wResult;
                    }
        ...
        public static SByte parseSByte(Object value, SByte wDefaultValue = 0)
        {
            SByte wResult = wDefaultValue;
            if (value != null)
            {
                try
                {
