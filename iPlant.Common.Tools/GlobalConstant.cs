...
namespace iPlant.Common.Tools
{
    public class GlobalConstant
    {
        ...
        private static String _DirectoryLogInfo = null;
        public static String DirectoryLogInfo
        {
            get
            {
                if (String.IsNullOrWhiteSpace(_DirectoryLogInfo))
                {
                    _DirectoryLogInfo = GlobalConstant.GlobalConfiguration.GetValue("Service.DirectoryLogInfo");
                }
                return _DirectoryLogInfo;
