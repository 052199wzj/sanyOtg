...
namespace iPlant.Common.Tools
{
    ...
    public class HttpHelper
    {
        ...
        public static string HttpGet(string url, string contentType = "text/html;charset=UTF-8", int timeout = 10 * 1000)
        {
        ...
        /// <returns>System.String.</returns>
        public static string HttpPost(string posturl,Dictionary<string,string> dicHeaderContent, string postData, string contentType = "application/x-www-form-urlencoded", int timeout = 10 * 1000)
        {
            ...
            try
            {
                ...
                foreach (var i in dicHeaderContent)
                {
