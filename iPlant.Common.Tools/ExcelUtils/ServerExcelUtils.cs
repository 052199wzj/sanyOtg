...
namespace iPlant.Common.Tools
{
    ...
    public class ServerExcelUtils
    {
        ...
        public ExcelExtType GetExcelFileType(string wFileFullPath)
        {
        ...
        public List<Dictionary<String, Object>> ImportExcel(Stream stream, ExcelExtType type, string sheetName)
        {
