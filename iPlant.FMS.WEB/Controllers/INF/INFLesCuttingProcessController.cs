...
{
    public class INFLesCuttingProcessController : BaseController
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger(typeof(INFLesCuttingProcessController));
        ...
        public ActionResult All()
        {
            ...
            try
            {
                ...
                ServiceResult<List<INFLesCuttingProcess>> wServerRst = ServiceInstance.mINFService.INF_QueryINFLesCuttingProcessList(
                    wBMSEmployee, wID, wNestId, wStatus, wStartTime, wEndTime, wPagination);
