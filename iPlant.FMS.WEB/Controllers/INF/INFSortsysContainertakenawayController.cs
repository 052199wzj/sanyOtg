...
{
    public class INFSortsysContainertakenawayController : BaseController
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger(typeof(INFSortsysContainertakenawayController));
        ...
        public ActionResult All()
        {
            ...
            try
            {
                ...
                ServiceResult<List<INFSortsysContainertakenaway>> wServerRst = ServiceInstance.mINFService.INF_QueryINFSortsysContainertakenawayList(
