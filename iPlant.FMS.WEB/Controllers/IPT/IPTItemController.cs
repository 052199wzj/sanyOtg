    ...
    public class IPTItemController : BaseController
    {
        ...
        public ActionResult RecordAll()
        {
            ...
            try
            {
                ...
                ServiceResult<List<IPTRecordItem>> wServiceResult = ServiceInstance.mIPTService.IPT_SelectRecordItemList(wBMSEmployee, wOrderID,wOrderNo, wItemID, wLineID, wProductID, wModelID, wProductLike, wIPTType, wModeType,
