    ...
    public class DMSProcessRecordController : BaseController
    {
        ...
        public ActionResult All()
        {
            ...
            try
            {
                ...
                ServiceResult<List<DMSProcessRecord>> wServiceResult = ServiceInstance.mDMSService.DMS_SelectProcessRecordList(wBMSEmployee, wLineID, wProductID, wProductNo, wOrderID, wOrderNo,
                    wDeviceID, wDeviceNo, wWorkpieceNo, wRecordType,
                    wActive, wStatus, wStartTime, wEndTime, wPagination);
