...
namespace iPlant.FMS.Models
{
    ...
    public class DMSDeviceStatusEnumTool
    {
        ...
        public Dictionary<String, Int32> ValuesDic = new Dictionary<String, Int32>();
        ...
        private DMSDeviceStatusEnumTool()
        {
            ...
            {
                Values.Add((int)wDMSDeviceStatusEnum);
                ValuesDic.Add(Enum.GetName(wDMSDeviceStatusEnum), (int)wDMSDeviceStatusEnum);
