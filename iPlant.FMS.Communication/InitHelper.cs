    ...
    public class InitHelper
    {
        ...
        private async Task Start()
        {
            try
            {
                ...
                var wDeviceEntityListDic = wDeviceEntityList.GroupBy(p => p.LineID).ToDictionary(p => p.Key, p => p.ToList());
        ...
        private List<DeviceEntity> LoadDeviceEntities()
        {
            ...
            ServiceResult<List<DMSDeviceLedger>> wDeviceLedgerResult = ServiceInstance.mDMSService.DMS_GetDeviceLedgerList(BaseDAO.SysAdmin,
                "", "", -1, -1, -1, -1, -1, -1, -1, 1, Pagination.MaxSize);
