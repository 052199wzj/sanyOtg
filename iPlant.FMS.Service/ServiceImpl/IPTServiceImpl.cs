...
namespace iPlant.FMC.Service
{
    public class IPTServiceImpl : IPTService, IDisposable
    {
        ...
        public ServiceResult<List<IPTRecordItem>> IPT_SelectRecordItemList(BMSEmployee wLoginUser, int wOrderID,string wOrderNo, int wItemID, int wLineID, int wProductID, int wModelID, String wProductLike, int wIPTType, int wModeType,
              ...
              int wStatus, Pagination wPagination)
        {
            ...
            {
                OutResult<Int32> wErrorCode = new OutResult<Int32>(0);
                wResult.setResult(IPTRecordItemDAO.getInstance().IPT_SelectRecordItemList(wLoginUser, wOrderID, wOrderNo,wItemID, wLineID, wProductID, wModelID, wProductLike, wIPTType, wModeType,
