...
namespace iPlant.FMC.Service
{
    public class WMSServiceImpl : WMSService
    {
        ...
        //public ServiceResult<List<WMSAgvTask>> WMS_SelectAgvTaskAll(BMSEmployee wLoginUser, int wLineID, string wWorkCenterName, int wDeviceID,
        ...
        //        wResult.Result = WMSAgvTaskDAO.getInstance().WMS_SelectAgvTaskAll(wLoginUser, -1, "", wLineID, wWorkCenterName,wDeviceID,
        ...
        public ServiceResult<List<WMSAgvTask>> WMS_SelectAgvTaskAll(BMSEmployee wLoginUser, int wLineID, string wWorkCenterName, int wDeviceID,
    string wDeviceLike, int wSourcePositionID, string wSourcePositionLike, int wTaskType,
    int wStatus, DateTime wStartTime, DateTime wEndTime, Pagination wPagination)
        {
            ServiceResult<List<WMSAgvTask>> wResult = new ServiceResult<List<WMSAgvTask>>();
            try
            {
        ...
        //public ServiceResult<List<WMSAgvTask>> WMS_SelectAgvCurrentTaskAll(BMSEmployee wLoginUser, int wLineID,string wWorkCenterName, int wDeviceID,
        //   string wDeviceLike, int wSourcePositionID, string wSourcePositionLike, int wTaskType)
        //{
        //    ServiceResult<List<WMSAgvTask>> wResult = new ServiceResult<List<WMSAgvTask>>();
        //    try
