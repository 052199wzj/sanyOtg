...
namespace iPlant.FMC.Service
{
    public class QMSServiceImpl : QMSService
    {
        ...
        public ServiceResult<List<QMSWorkpieceCheckResult>> QMS_GetWorkpieceCheckResultList(BMSEmployee wLoginUser, int wLineID, int wCommandID, int wOrderID,
                ...
                DateTime wStartTime, DateTime wEndTime, Pagination wPagination)
        {
            ...
            try
            {
                wResult.Result = new List<QMSWorkpieceCheckResult>();
             ...
             wCheckResult, wSpotCheckResult, wPatrolCheckResult, wThreeDimensionalResult,
                ...
                List<QMSCheckResult> wQMSCheckResultList = QMSCheckResultDAO.getInstance().QMS_SelectCheckResultList(wLoginUser, wLineID, wOrderID,
                     wOrderNo, wProductID, wProductNo, wWorkpieceNo, wStatus,
                     wCheckResult, wSpotCheckResult, wPatrolCheckResult, wThreeDimensionalResult,
                 wStartTime, wEndTime, Pagination.Create(1, int.MaxValue), wErrorCode);
        ...
        public ServiceResult<List<QMSThreeDimensionalSet>> QMS_GetThreeDimensionalSetAll(BMSEmployee wLoginUser, int wProductID,
            String wProductNoLike, String wCheckParameterLike, Pagination wPagination)
        {
            ...
            try
            {
                ...
                wResult.setResult(QMSThreeDimensionalCheckResultDAO.getInstance().QMS_GetThreeDimensionalSetAll(wLoginUser, wProductID,
                    wProductNoLike, wCheckParameterLike, wPagination, wErrorCode));
