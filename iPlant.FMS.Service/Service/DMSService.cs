...
namespace iPlant.FMC.Service
{
    public interface DMSService
    {
        ...
        ServiceResult<List<DMSPosition>> DMS_GetPositionList(BMSEmployee wLoginUser, int wLineID, String wName, int wActive);
        ...
        ServiceResult<List<DMSProcessRecord>> DMS_CurrentProcessRecordList(BMSEmployee wLoginUser, int wDeviceID, String wDeviceNo, int wActive, Pagination wPagination);


        ServiceResult<List<DMSProcessRecord>> DMS_SelectProcessRecordList(BMSEmployee wLoginUser, int wLineID, int wProductID, String wProductNo, int wOrderID, String wOrderNo, int wDeviceID, String wDeviceNo, String wWorkpieceNo, int wRecordType,
        ...
        /// <returns></returns>
        ServiceResult<Int32> DMS_SyncDeviceAlarm(BMSEmployee wLoginUser, String wAssetNo, String wAlarmCode, int wEventType, int wIsCode, String wAlarmMsg = "");
