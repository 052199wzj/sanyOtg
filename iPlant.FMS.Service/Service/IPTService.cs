...
namespace iPlant.FMC.Service
{
    public interface IPTService
    {
        ...
        ServiceResult<List<IPTRecordItem>> IPT_SelectRecordItemList(BMSEmployee wLoginUser, int wOrderID,string wOrderNo, int wItemID, int wLineID, int wProductID, int wModelID, String wProductLike, int wIPTType, int wModeType,
