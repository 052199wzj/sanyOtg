...
namespace iPlant.FMC.Service
{
    ...
    {
        //ServiceResult<List<WMSAgvTask>> WMS_SelectAgvTaskAll(BMSEmployee wLoginUser, int wLineID,string wWorkCenterName, int wDeviceID,
        ...
        ServiceResult<List<WMSAgvTask>> WMS_SelectAgvTaskAll(BMSEmployee wLoginUser, int wLineID, string wWorkCenterName, int wDeviceID,
     string wDeviceLike, int wSourcePositionID, string wSourcePositionLike, int wTaskType, int wStatus, DateTime wStartTime, DateTime wEndTime, Pagination wPagination);
        //ServiceResult<List<WMSAgvTask>> WMS_SelectAgvCurrentTaskAll(BMSEmployee wLoginUser, int wLineID, string wWorkCenterName,int wDeviceID,
