...
{
    public class INFSortsysEmptycontainerarrivalDAO : BaseDAO
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger(typeof(INFSortsysEmptycontainerarrivalDAO));

        #region 单实例
        private INFSortsysEmptycontainerarrivalDAO() { }
        private static INFSortsysEmptycontainerarrivalDAO _Instance;

        public static INFSortsysEmptycontainerarrivalDAO Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new INFSortsysEmptycontainerarrivalDAO();
                return INFSortsysEmptycontainerarrivalDAO._Instance;
            }
        }
        #endregion

        public List<INFSortsysEmptycontainerarrival> INF_QueryINFSortsysEmptycontainerarrivalList(
        ...
        {
            List<INFSortsysEmptycontainerarrival> wResultList = new List<INFSortsysEmptycontainerarrival>();
            wErrorCode = 0;
            ...
            try
            {
                ...
                String wSQL = String.Format(
                    "SELECT t.* FROM {0}.inf_sortsys_emptycontainerarrival t WHERE 1=1 " +
                ...
                {
                    INFSortsysEmptycontainerarrival wItem = new INFSortsysEmptycontainerarrival();
            ...
            catch (Exception ex)
            {
                ...
                logger.Error("INF_QueryINFSortsysEmptycontainerarrivalList", ex);
