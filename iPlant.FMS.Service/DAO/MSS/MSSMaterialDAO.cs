    ...
    class MSSMaterialDAO : BaseDAO
    {
        ...
        public List<MSSMaterial> GetAll(BMSEmployee wLoginUser, string wMaterialNo, string wMaterialName, string wGroes, int wActive, Pagination wPagination, OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                ...
                String wSQL = "select t.ID,t.MaterialNo,t.MaterialName,t.Groes,t.Remark,t.CreateTime,t.EditTime,t.Active,t.CreatorID,t.EditorID,t.Weight,t.ImageUrl,t1.Name as Creator,t2.Name as Editor " + wSqlCondition;
                ...
                foreach (Dictionary<String, Object> wReader in wQueryResult)
                {
                    ...
                    wMaterial.Weight = StringUtils.parseDouble(wReader["Weight"]);
                    wMaterial.ImageUrl = StringUtils.parseString(wReader["ImageUrl"]);
        ...
        public void Update(BMSEmployee wLoginUser, MSSMaterial wMSSMaterial, OutResult<Int32> wErrorCode)
        {
            try
            {
                ...
                wParamMap.Add("Weight", wMSSMaterial.Weight);
                wParamMap.Add("ImageUrl", wMSSMaterial.ImageUrl);
