    ...
    class QMSWorkpieceDAO : BaseDAO
    {
        ...
        public bool QMS_UpdateWorkpiece(BMSEmployee wLoginUser, QMSWorkpiece wQMSWorkpiece, OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                ...
                if (StringUtils.isNotEmpty(wQMSWorkpiece.Remark))
        ...
        /// <param name="wErrorCode"></param>
        /// <returns></returns>
        public bool QMS_UpdateWorkpieceResult(BMSEmployee wLoginUser, String wWorkpieceNo, String wPropertyName, int wResult, OutResult<Int32> wErrorCode)
        {
        ...
        /// <param name="wErrorCode"></param>
        /// <returns></returns>
        public bool QMS_UpdateWorkpieceResult(BMSEmployee wLoginUser, int wWorkpieceID, String wPropertyName, int wResult, OutResult<Int32> wErrorCode)
        {
        ...
        public bool QMS_UpdateWorkpieceStatus(BMSEmployee wLoginUser, String wWorkpieceNo, String wOrderNo, int wStatus, String wRemark, OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                ...
                this.Update(StringUtils.Format(" {0}.qms_workpiece  ", wInstance), "WorkpieceNo", wParamMap, " and Status in (", StringUtils.Join(",", wAllowStatus), ") ");
