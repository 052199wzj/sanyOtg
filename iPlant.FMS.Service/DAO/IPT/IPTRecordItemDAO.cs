...
namespace iPlant.FMC.Service
{
    class IPTRecordItemDAO : BaseDAO
    {
        ...
        public List<IPTRecordItem> IPT_SelectRecordItemList(BMSEmployee wLoginUser, int wOrderID, string wOrderNo, int wItemID,
            ...
            try
            {
                ...
                String wSQL = StringUtils.Format(
                        ...
                        "  FROM {0}.ipt_recorditem t inner join {0}.fmc_line t1  on t.LineID=t1.ID "
                                ...
                                + " left join {0}.oms_orderItem t8 on t.OrderID=t8.ID  "
                        ...
                        + " and ( @wOrderNo ='' or t8.OrderNo like @wOrderNo )  "
                ...
                OutResult<Int32> wErrorCode)
        {
            try
            {
                ...
                foreach (IPTRecordItemValue wIPTRecordItemValue in wItemList)
                {
                    ...
                    {
                        //修改workpiece状态 
                        QMSWorkpieceDAO.getInstance().QMS_UpdateWorkpieceResult(wLoginUser, wIPTRecordItemValue.WorkpieceID, "PatrolCheckResult", wIPTRecordItemValue.Result, wErrorCode);
