...
namespace iPlant.FMC.Service
{
    class DMSDeviceLedgerDAO : BaseDAO
    {
                ...
                OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                wResult = DMS_SelectDeviceLedgerList(wLoginUser, null, "", wName, wAssetNo, wDeviceType, wModelID, wFactoryID, wWorkShopID, wLineID, wAreaID, wTeamID, wActive, wPagination,
                        wErrorCode);
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (wID > 0)
                {
                    ...
                    wDMSDeviceLedgerList = this.DMS_SelectDeviceLedgerList(wLoginUser, wIDList, "", "",
                     "", -1, -1, -1, -1, -1, -1 - 1, -1, -1, Pagination.Default, wErrorCode);
                }
