...
namespace iPlant.FMC.Service
{
    class WMSAgvTaskDAO : BaseDAO
    {
        ...
        public List<WMSAgvTask> WMS_SelectAgvTaskAll(BMSEmployee wLoginUser, int wID, String wCode, int wLineID, string wWorkCenterName,int wDeviceID, String wDeviceLike,
            int wSourcePositionID, String wSourcePositionLike, int wTaskType,
            int wStatus, DateTime wStartTime, DateTime wEndTime, Pagination wPagination, OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                ...
                String wSQL = StringUtils.Format(
                        " SELECT t.*,t1.Name as DeviceName,t1.Code as DeviceNo," +
                        " t1.Name as SourcePositionName ,t1.Code as SourcePositionCode,t4.Name as ConfirmerName, t5.Name as WorkCenterName" +
                        " From  {0}.wms_agvtask t inner join {0}.dms_device_ledger t1 on t.DeviceID=t1.ID" +
                        " left join {0}.mbs_user t4 on t.ConfirmerID=t4.ID" +
                        " left join {0}.mss_materialpoint t5 on t.SourcePositionID=t5.ID" +
                        ...
                        " and (@wWorkCenterName = '' or  t5.Name=@wWorkCenterName) " +
                ...
                wParamMap.Add("wWorkCenterName", wWorkCenterName);
        ...
        public bool WMS_CheckAgvTask(BMSEmployee wLoginUser, WMSAgvTask wWMSAgvTask, OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                ...
                String wSQL = StringUtils.Format(
                        ...
                        " and t.Status in ({1})  ", wInstance, StringUtils.Join(",", wAgvStatus));
        ...
        public WMSAgvTask WMS_SelectAgvTask(BMSEmployee wLoginUser, int wID, String wCode, OutResult<Int32> wErrorCode)
        {
            ...
            try
            {
                ...
                List<WMSAgvTask> wWMSAgvTaskList = WMS_SelectAgvTaskAll(wLoginUser, wID, wCode,
                    -1,"" ,-1, "", -1, "", -1,-1, new DateTime(2000, 1, 1), new DateTime(2000, 1, 1), Pagination.Default, wErrorCode);
        ...
        public void WMS_UpdateAgvTask(BMSEmployee wLoginUser, WMSAgvTask wWMSAgvTask, OutResult<Int32> wErrorCode)
        {
            try
            {
                ...
                if (wWMSAgvTask.ID > 0 && this.WMS_CheckAgvTask(wLoginUser, wWMSAgvTask, wErrorCode))
                {
